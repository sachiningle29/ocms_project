...
<template>
    <div class="card">
        ...
        <DataTable ref="dt" v-model:selection="selectedUsers" :value="users" dataKey="id" :paginator="true" :rows="10" :filters="filters" :rowsPerPageOptions="[5, 10, 25]" currentPageReportTemplate="Showing {first} to {last} of {totalRecords} users">
            ...
            <Column field="section" header="Section Name" sortable />
        ...
        <!-- Create/Edit Dialog -->
        <Dialog v-model:visible="userDialog" :draggable="false" modal header="Section Details" :closable="false" style="width: 40vw">
            <div class="p-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="font-bold mb-1 block">Sub Section</label>
